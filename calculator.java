 ...
 { 
  ...
  public static void main(String args[]) 
   { 
    ...
    l = new JTextField(16); 
    l.setEditable(false); 
    JButton b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, ba, bs, bd, bm, be, beq, beq1,bmod, bsin, bcos, btan, bsqrt,bpow,blog; 
    b0 = new JButton("0"); 
    b1 = new JButton("1"); 
    b2 = new JButton("2"); 
    b3 = new JButton("3"); 
  ...
  public void actionPerformed(ActionEvent e) 
   { 
	...
	te = (Double.parseDouble(s0) * Double.parseDouble(s2));
        ...
        te = Math.cos(Math.toRadians(Double.parseDouble(s2)));
      else if (s1.equals("sin"))
        te = Math.sin(Math.toRadians(Double.parseDouble(s2)));
      else if (s1.equals("tan"))
        te = Math.tan(Math.toRadians(Double.parseDouble(s2)));
      else if (s1.equals("SQRT"))
        te = Math.sqrt(Double.parseDouble(s2));
      else if (s1.equals("^"))
